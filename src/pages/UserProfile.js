...
import {
  ...
  Save, Notifications, AttachMoney, Palette, CheckCircle,
...
export default function UserProfile() {
  ...
  const handleChangePassword = async () => {
    ...
    if (passwords.nuevo !== passwords.confirm) {
    ...
    try {
      await new Promise((r) => setTimeout(r, 500));
      changePassword(passwords.current, passwords.nuevo);
        ...
        <Grid item xs={12} md={4}>
          <Paper sx={{ p: 3, textAlign: 'center' }}>
            ...
            <Box sx={{ position: 'relative', display: 'inline-block', mb: 2 }}>
              <Avatar
                sx={{
                  width: 80, height: 80, fontSize: isEmojiAvatar ? '2.2rem' : '2rem',
                  bgcolor: 'rgba(79,195,247,0.15)', border: '2px solid rgba(79,195,247,0.3)',
        ...
        <Grid item xs={12} md={8}>
          ...
          <Paper sx={{ p: 3, mb: 2.5 }}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth label="Nombre completo" value={profile.name}
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth label="Correo electrónico" value={profile.email}
                  disabled size="small"
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth label="Ingreso predeterminado (MXN)"
                  value={profile.defaultIncome} type="number"
              ...
              <Grid item xs={12} sm={6}>
                <TextField
                  fullWidth select label="Moneda" value={profile.currency}
          ...
          <Paper sx={{ p: 3, mb: 2.5 }}>
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={prefs.showUSD}
                  onChange={(e) => setPrefs((p) => ({ ...p, showUSD: e.target.checked }))}
            ...
            <FormControlLabel
              control={
                <Switch
                  checked={prefs.alertCarro}
                  onChange={(e) => setPrefs((p) => ({ ...p, alertCarro: e.target.checked }))}
                />
              }
            ...
            {prefs.alertCarro && (
              <Box sx={{ px: 1 }}>
                ...
                <Slider
                  ...
                  onChange={(_, v) => setPrefs((p) => ({ ...p, alertThreshold: v }))}
          ...
          <Paper sx={{ p: 3 }}>
            ...
            <Box sx={{ mt: 2, display: 'flex', justifyContent: 'flex-end' }}>
              <Button
                variant="outlined" onClick={handleChangePassword} disabled={savingPass}
